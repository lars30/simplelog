...
// init vars, run some initial functions
{
	...
	search_div = document.getElementById('searchWrap');
	results_wrapper_div = document.getElementById('resultWrap');
	...
	archive_block = document.getElementById('archives');
...
{
	if (archive_block.style.display == 'block')
	{
		archive_block.style.display = 'none';
	}
	else
	{
		archive_block.style.display = 'block';
	}
}
